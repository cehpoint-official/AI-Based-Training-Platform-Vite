...
const ExpectationPage = () => {
  ...
  const { skills, setSkills } = useContext(skillsContext); // Added setSkills for updating context
  ...
  useEffect(() => {
    const fetchReport = async () => {
      ...
      setError(null);
      try {
        const fetchedReport = await getTestReportsFromFirebase(user.email);
    ...
    // If email is available in skills context, fetch report
    if (skills.email) {
      fetchReport();
    }
  }, [skills.email]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const reportData = {
        ...
        expectations: updatedReport.expectations,
      };
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Salary Expectation */}
        <div className="mb-6 relative group tooltip-container" data-field="salary">
          ...
          <div className="absolute top-3 right-3">
            ...
            >
              ...
              {tooltipVisible.salary && tooltipMessages.salary && (
                <Tooltip message={tooltipMessages.salary} onClose={() => closeTooltip('salary')} />
              )}
            </button>
          </div>
        </div>
        ...
        {/* Career Growth */}
        <div className="mb-6 relative group tooltip-container" data-field="careerGrowth">
          ...
          <div className="absolute top-3 right-3">
            ...
            >
              ...
              {tooltipVisible.careerGrowth && tooltipMessages.careerGrowth && (
                <Tooltip message={tooltipMessages.careerGrowth} onClose={() => closeTooltip('careerGrowth')} />
              )}
            </button>
          </div>
        </div>
        ...
        <div className="mb-6 relative group tooltip-container" data-field="learningOpportunities">
          ...
          <div className="absolute top-3 right-3">
            ...
            >
              ...
              {tooltipVisible.learningOpportunities && tooltipMessages.learningOpportunities && (
                <Tooltip message={tooltipMessages.learningOpportunities} onClose={() => closeTooltip('learningOpportunities')} />
              )}
            </button>
          </div>
        </div>
