...
const UserDetailsModal = ({ setUserDetails, setResumeData, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex flex-col md:flex-row z-50 w-full h-full bg-white">
      {/* Content Section */}
      <div className=" bg- md:p-10 w-full md:w-1/2 flex justify-center items-center">
        <div className="flex flex-col justify-center items-center bg-white px-5 w-full  rounded-lg ">
          <h2 className="text-xl md:text-2xl font-bold mb-4 text-gray-800 text-center mt-5">
      ...
      {/* SVG Section */}
      <div className="flex-1 flex justify-center items-center bg-gray-100 p-4 md:p-10">
